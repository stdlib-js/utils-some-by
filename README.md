...
```javascript
someBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-some-by@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/utils-some-by/tags). For example,

```javascript
someBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-some-by@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var someBy = require( 'path/to/vendor/umd/utils-some-by/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-some-by@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/utils-some-by/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/utils-some-by/actions/workflows/test.yml?query=branch:v0.2.0
...
[deno-readme]: https://github.com/stdlib-js/utils-some-by/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/utils-some-by/tree/umd
[umd-readme]: https://github.com/stdlib-js/utils-some-by/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/utils-some-by/tree/esm
[esm-readme]: https://github.com/stdlib-js/utils-some-by/blob/esm/README.md
